...
function Home({ produtos, funcionarios, adicionarCarrinho }) {
  // Busca e filtros do cardápio para facilitar a navegação do cliente.
  ...
  return (
    <div className="conteudo-principal">
            ...
            <div className="filtros-cardapio">
              {categorias.map((categoria) => (
                <button
                  ...
                  type="button"
                  className={
                    categoriaSelecionada === categoria ? "filtro ativo" : "filtro"
                  }
      ...
      {/* Lateral com destaque para os funcionários da lanchonete. */}
